...
export const SawSharpening: FC = () => (
    <>
        <Title title='Saw Sharpening Service in the Greater Phoenix, AZ Area'/>
                ...
                <div className={s.innerContent}>
                    <div className={s.text}>
                        <div>
                            ...
                            the Greater Phoenix area since 1967. Over the last 40 years, we have proven our commitment
                            to
                            our customers by only using the latest technology in our work. In addition to sharpening
                            saws,
                            ...
                            a contractor, or a large corporation, we can provide you with the blade you need, no matter
                            your
                            purpose or machine.
                        </div>
